...
export function Modalidades() {
  ...
  return (
    <section className="relative bg-bg py-28 md:py-40" aria-label="Modalidades">
          ...
          <ul className="flex flex-col" role="list">
            {MODS.map((m, i) => (
              <li key={m.nome}>
                ...
                >
                  <span className={`font-display uppercase tracking-tight transition-all duration-300 ${
                    i === 0
