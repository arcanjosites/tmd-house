...
const FRAMES = IMAGES.hero.frames;
...
const PHRASES: Phrase[] = [
  { text: "JIU JITSU", sub: "TMD House · Instituto Brazilian Jiu-Jitsu", range: [0.0, 0.14], align: "center" },
  { text: "DISCIPLINA.", sub: "Todos os dias. Sem exceção.", range: [0.15, 0.3], align: "left" },
  { text: "TÉCNICA.", sub: "Detalhe sobre detalhe.", range: [0.32, 0.47], align: "right" },
  { text: "CONTROLE.", sub: "Do corpo. Da mente. Da luta.", range: [0.49, 0.64], align: "center" },
  { text: "EVOLUÇÃO.", sub: "Cada treino constrói.", range: [0.66, 0.8], align: "bottom" },
  { text: "MAIS QUE LUTA.", sub: "TMD House", range: [0.82, 1.0], align: "center" },
];
...
export function Hero() {
  ...
  if (reduced) {
    return (
      <section className="relative h-screen overflow-hidden" aria-label="TMD House Jiu-Jitsu">
  ...
  return (
    <section ref={wrapRef} className="relative h-[380vh] md:h-[600vh]" aria-label="TMD House Jiu-Jitsu">
      <div className="sticky top-0 h-screen overflow-hidden">
        ...
        >
          ...
          {/* CTA at end */}
          <HeroBottomUI progress={scrollYProgress} />
...
function HeroBottomUI({
  ...
  const ctaY = useTransform(progress, [0.92, 0.97], [28, 0]);

  return (
    <div className="pointer-events-none absolute inset-x-0 bottom-0 z-20 h-32 md:h-36">
      <motion.div
        style={{ opacity: hintOpacity }}
        className="absolute inset-x-0 bottom-10 text-center md:bottom-12"
      >
