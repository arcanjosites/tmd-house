...
const ITENS = [
  { src: "/images/gym/tatame.jpg", alt: "Tatame principal da TMD House", label: "Tatame principal", span: "md:col-span-7 md:row-span-2 aspect-[16/10]" },
  { src: "/images/gym/weights.jpg", alt: "Área de musculação", label: "Área de força", span: "md:col-span-5 aspect-[4/3]" },
  { src: "/images/gym/bags.jpg", alt: "Área funcional com sacos de pancada", label: "Área funcional", span: "md:col-span-5 aspect-[4/3]" },
  { src: "/images/gym/reception.jpg", alt: "Recepção da academia", label: "Recepção", span: "md:col-span-6 aspect-[16/9]" },
  { src: "/images/athlete-2.jpg", alt: "Atleta com jaqueta TMD House", label: "A casa é nossa", span: "md:col-span-6 aspect-[16/9]" },
];
...
export function Estrutura() {
  ...
  return (
    <section ref={ref} className="relative bg-bg2 py-28 md:py-40" aria-label="Estrutura da academia">
