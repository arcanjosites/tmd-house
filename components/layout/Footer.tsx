        ...
        <div className="grid gap-12 md:grid-cols-[2fr_1fr_1fr]">
          <div>
            <div className="flex items-center gap-4">
              <Image src="/images/logo.jpg" alt="Logo TMD House" width={64} height={64} className="rounded-full" />
              <div>
          ...
          <nav aria-label="Links do site">
            ...
            <ul className="mt-5 space-y-2.5">
              {NAV_LINKS.map((l) => (
                <li key={l.href}>
                  <Link href={l.href} className="text-sm text-fg transition-colors hover:text-green-highlight">
                    {l.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="mt-5 space-y-2.5 text-sm text-fg-muted">
              <li>Brasília — DF</li>
              <li>Seg a Sáb · 06h — 22h</li>
              <li>
                <a href="mailto:contato@tmdhouse.com.br" className="text-fg hover:text-green-highlight">
                  contato@tmdhouse.com.br
                </a>
              </li>
              <li>
                <a href="https://instagram.com" target="_blank" rel="noreferrer" className="text-fg hover:text-green-highlight">
                  Instagram
                </a>
              </li>
            </ul>
