    ...
    <>
      ...
      >
        <div className="mx-auto flex h-16 md:h-20 max-w-[1600px] items-center justify-between px-5 md:px-10">
          <Link href="/" prefetch className="flex items-center gap-3" aria-label="TMD House, página inicial" onClick={() => setOpen(false)}>
            <Image
              src={IMAGES.logo}
              alt="Logo TMD House"
              width={44}
          ...
          <div className="flex items-center gap-4 md:gap-6">
            <Link
              href="/contato"
              prefetch
              className="liquid-btn rounded-full px-5 py-2.5 font-display text-[10px] font-medium uppercase tracking-[0.16em] sm:px-6 sm:text-xs"
            >
      ...
      <AnimatePresence>
        {open && (
          <motion.nav
            ...
            className="fixed inset-0 z-40 bg-bg2/92 backdrop-blur-xl"
          ...
          >
            ...
            <div className="relative flex h-full flex-col justify-center px-6 md:px-16 lg:px-24">
              ...
              >
                <a href={SITE_CONTACT.instagram} target="_blank" rel="noreferrer" className="hover:text-fg">
