...
const PILARES = [
  ...
  { nome: "Kids & Família", desc: "Disciplina e postura para crianças, com turmas em que os pais treinam junto." },
];
...
export default function KaratePage() {
  return (
    <>
      ...
      />
      <section className="relative bg-bg/60 backdrop-blur-sm py-24 md:py-32" aria-label="Pilares do Karatê">
